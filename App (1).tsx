...
const App: React.FC = () => {
  ...
  const hasApiKey = useMemo(() => {
    // En AI Studio, la clave puede venir en GEMINI_API_KEY o en API_KEY
    const key = process.env.GEMINI_API_KEY || process.env.API_KEY;
    // Si estamos en el entorno de AI Studio, a veces la clave no está disponible 
    // en tiempo de compilación pero sí en ejecución. 
    // Si el usuario configuró algo en el panel de Secrets, confiamos en eso.
